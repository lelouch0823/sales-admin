...
export const MOCK_INVENTORY: InventoryBalance[] = [
  ...
  // SH Store
  { id: 'i3', sku: 'SKU001', warehouseId: 'wh-sh-001', onHand: 15, reserved: 2, inTransitIn: 0, inTransitOut: 0 }, // 13 Available
  { id: 'i4', sku: 'SKU002', warehouseId: 'wh-sh-001', onHand: 0, reserved: 0, inTransitIn: 5, inTransitOut: 0 }, // 0 Available (but incoming)

  // BJ Store
  { id: 'i5', sku: 'SKU001', warehouseId: 'wh-bj-002', onHand: 0, reserved: 0, inTransitIn: 0, inTransitOut: 0 }, // Backorder allowed

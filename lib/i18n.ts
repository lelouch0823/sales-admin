...
const resources = {
  en: {
    translation: {
      ...
      "dashboard": {
        ...
        "welcome_sub": "You are logged in as <1>{{role}}</1>. Manage your store recommendations, customer relationships, and system permissions efficiently.",
        "stats": {
  ...
  zh: {
    translation: {
      ...
      "dashboard": {
        "welcome": "欢迎回来, {{name}}",
        "welcome_sub": "您当前的登录身份是 <1>{{role}}</1>。请高效管理您的门店推荐、客户关系及系统权限。",
        "stats": {

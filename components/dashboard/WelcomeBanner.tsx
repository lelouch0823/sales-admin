      ...
      <div className="relative z-10">
        ...
        <p className="text-gray-300 max-w-xl text-sm leading-relaxed">
          <Trans i18nKey="dashboard.welcome_sub" values={{ role: currentUser.role }}>
            ...
            <span className="font-mono font-bold text-blue-300">{currentUser.role}</span>. Manage
            your store recommendations, customer relationships, and system permissions efficiently.
          </Trans>
        </p>
      </div>
